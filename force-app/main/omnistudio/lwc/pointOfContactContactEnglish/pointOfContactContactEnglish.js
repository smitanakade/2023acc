...
import { OMNIDEF } from './pointOfContactContactEnglish_def.js';
import tmpl from './pointOfContactContactEnglish.html';
import tmpl_nds from './pointOfContactContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pointOfContactContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
