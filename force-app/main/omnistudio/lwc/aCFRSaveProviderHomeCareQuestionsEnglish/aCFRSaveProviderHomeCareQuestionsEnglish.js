...
import { OMNIDEF } from './aCFRSaveProviderHomeCareQuestionsEnglish_def.js';
import tmpl from './aCFRSaveProviderHomeCareQuestionsEnglish.html';
import tmpl_nds from './aCFRSaveProviderHomeCareQuestionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRSaveProviderHomeCareQuestionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
