...
import { OMNIDEF } from './sRQIHoldStarRatingsEnglish_def.js';
import tmpl from './sRQIHoldStarRatingsEnglish.html';
import tmpl_nds from './sRQIHoldStarRatingsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sRQIHoldStarRatingsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
