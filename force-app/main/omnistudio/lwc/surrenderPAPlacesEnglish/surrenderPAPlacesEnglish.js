...
import { OMNIDEF } from './surrenderPAPlacesEnglish_def.js';
import tmpl from './surrenderPAPlacesEnglish.html';
import tmpl_nds from './surrenderPAPlacesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class surrenderPAPlacesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
