...
import { OMNIDEF } from './approvedProviderCreateEnglish_def.js';
import tmpl from './approvedProviderCreateEnglish.html';
import tmpl_nds from './approvedProviderCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class approvedProviderCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
