...
import { OMNIDEF } from './serviceCreateEnglish_def.js';
import tmpl from './serviceCreateEnglish.html';
import tmpl_nds from './serviceCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
