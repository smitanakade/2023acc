...
import { OMNIDEF } from './aCFRAddMissingServiceEnglish_def.js';
import tmpl from './aCFRAddMissingServiceEnglish.html';
import tmpl_nds from './aCFRAddMissingServiceEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRAddMissingServiceEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
