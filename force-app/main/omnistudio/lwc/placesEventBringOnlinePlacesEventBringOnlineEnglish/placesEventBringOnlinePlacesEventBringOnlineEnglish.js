...
import { OMNIDEF } from './placesEventBringOnlinePlacesEventBringOnlineEnglish_def.js';
import tmpl from './placesEventBringOnlinePlacesEventBringOnlineEnglish.html';
import tmpl_nds from './placesEventBringOnlinePlacesEventBringOnlineEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesEventBringOnlinePlacesEventBringOnlineEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
