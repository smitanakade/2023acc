...
import { OMNIDEF } from './keyPersonnelContactEnglish_def.js';
import tmpl from './keyPersonnelContactEnglish.html';
import tmpl_nds from './keyPersonnelContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class keyPersonnelContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
