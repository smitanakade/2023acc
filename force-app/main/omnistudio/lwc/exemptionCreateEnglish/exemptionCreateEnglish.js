...
import { OMNIDEF } from './exemptionCreateEnglish_def.js';
import tmpl from './exemptionCreateEnglish.html';
import tmpl_nds from './exemptionCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class exemptionCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
