...
import { OMNIDEF } from './createAssociatedAccountEnglish_def.js';
import tmpl from './createAssociatedAccountEnglish.html';
import tmpl_nds from './createAssociatedAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createAssociatedAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
