...
import { OMNIDEF } from './eventValidationEnglish_def.js';
import tmpl from './eventValidationEnglish.html';
import tmpl_nds from './eventValidationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eventValidationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
