...
import { OMNIDEF } from './qFRFormFinancialDatatableEnglish_def.js';
import tmpl from './qFRFormFinancialDatatableEnglish.html';
import tmpl_nds from './qFRFormFinancialDatatableEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qFRFormFinancialDatatableEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
