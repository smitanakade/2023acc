...
import { OMNIDEF } from './benchmarkerCreateEnglish_def.js';
import tmpl from './benchmarkerCreateEnglish.html';
import tmpl_nds from './benchmarkerCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class benchmarkerCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
