...
import { OMNIDEF } from './applicationRecommendationEnglish_def.js';
import tmpl from './applicationRecommendationEnglish.html';
import tmpl_nds from './applicationRecommendationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationRecommendationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
