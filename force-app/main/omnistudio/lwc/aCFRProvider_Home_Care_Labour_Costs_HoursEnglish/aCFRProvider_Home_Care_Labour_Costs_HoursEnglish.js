...
import { OMNIDEF } from './aCFRProvider_Home_Care_Labour_Costs_HoursEnglish_def.js';
import tmpl from './aCFRProvider_Home_Care_Labour_Costs_HoursEnglish.html';
import tmpl_nds from './aCFRProvider_Home_Care_Labour_Costs_HoursEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRProvider_Home_Care_Labour_Costs_HoursEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
