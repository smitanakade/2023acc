...
import { OMNIDEF } from './relinquishPlacesRelinquishPlacesEnglish_def.js';
import tmpl from './relinquishPlacesRelinquishPlacesEnglish.html';
import tmpl_nds from './relinquishPlacesRelinquishPlacesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class relinquishPlacesRelinquishPlacesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
