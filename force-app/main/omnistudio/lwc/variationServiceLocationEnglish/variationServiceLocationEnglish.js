...
import { OMNIDEF } from './variationServiceLocationEnglish_def.js';
import tmpl from './variationServiceLocationEnglish.html';
import tmpl_nds from './variationServiceLocationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationServiceLocationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
