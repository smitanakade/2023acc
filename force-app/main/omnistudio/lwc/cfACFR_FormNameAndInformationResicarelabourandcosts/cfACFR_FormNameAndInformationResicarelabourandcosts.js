import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import { load } from "omnistudio/newportLoader";
          ...
          export default class cfACFR_FormNameAndInformationResicarelabourandcosts extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfACFR_FormNameAndInformationResicarelabourandcosts';
