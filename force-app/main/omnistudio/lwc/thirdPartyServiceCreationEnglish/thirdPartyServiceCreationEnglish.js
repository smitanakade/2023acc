...
import { OMNIDEF } from './thirdPartyServiceCreationEnglish_def.js';
import tmpl from './thirdPartyServiceCreationEnglish.html';
import tmpl_nds from './thirdPartyServiceCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class thirdPartyServiceCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
