...
import { OMNIDEF } from './placesBringOnlinePlacesBringOnlineEnglish_def.js';
import tmpl from './placesBringOnlinePlacesBringOnlineEnglish.html';
import tmpl_nds from './placesBringOnlinePlacesBringOnlineEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesBringOnlinePlacesBringOnlineEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
