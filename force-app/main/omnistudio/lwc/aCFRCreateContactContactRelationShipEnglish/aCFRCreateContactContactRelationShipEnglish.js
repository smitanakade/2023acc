...
import { OMNIDEF } from './aCFRCreateContactContactRelationShipEnglish_def.js';
import tmpl from './aCFRCreateContactContactRelationShipEnglish.html';
import tmpl_nds from './aCFRCreateContactContactRelationShipEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRCreateContactContactRelationShipEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
