...
import { OMNIDEF } from './variationDistributionEnglish_def.js';
import tmpl from './variationDistributionEnglish.html';
import tmpl_nds from './variationDistributionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationDistributionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
