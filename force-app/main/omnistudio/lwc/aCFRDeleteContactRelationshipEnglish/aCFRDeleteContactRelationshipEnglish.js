...
import { OMNIDEF } from './aCFRDeleteContactRelationshipEnglish_def.js';
import tmpl from './aCFRDeleteContactRelationshipEnglish.html';
import tmpl_nds from './aCFRDeleteContactRelationshipEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRDeleteContactRelationshipEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
