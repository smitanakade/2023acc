...
import { OMNIDEF } from './qFRFormDownloadEnglish_def.js';
import tmpl from './qFRFormDownloadEnglish.html';
import tmpl_nds from './qFRFormDownloadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class qFRFormDownloadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
