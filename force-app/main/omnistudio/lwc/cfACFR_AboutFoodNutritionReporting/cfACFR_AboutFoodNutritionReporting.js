import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import { load } from "omnistudio/newportLoader";
          ...
          export default class cfACFR_AboutFoodNutritionReporting extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfACFR_AboutFoodNutritionReporting';
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-0koBm00000009krIAA"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00PBm000000rA1KMAU").then(() =>{
                    //Loading Custom CSS.
                  })
                });
