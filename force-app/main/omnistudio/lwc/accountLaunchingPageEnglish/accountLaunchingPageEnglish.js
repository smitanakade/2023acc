...
import { OMNIDEF } from './accountLaunchingPageEnglish_def.js';
import tmpl from './accountLaunchingPageEnglish.html';
import tmpl_nds from './accountLaunchingPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class accountLaunchingPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
