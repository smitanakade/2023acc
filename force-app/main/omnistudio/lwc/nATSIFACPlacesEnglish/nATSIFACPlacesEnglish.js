...
import { OMNIDEF } from './nATSIFACPlacesEnglish_def.js';
import tmpl from './nATSIFACPlacesEnglish.html';
import tmpl_nds from './nATSIFACPlacesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nATSIFACPlacesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
