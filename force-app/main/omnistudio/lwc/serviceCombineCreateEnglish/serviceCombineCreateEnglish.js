...
import { OMNIDEF } from './serviceCombineCreateEnglish_def.js';
import tmpl from './serviceCombineCreateEnglish.html';
import tmpl_nds from './serviceCombineCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceCombineCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
