import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfACFR_ProviderContactDetailsV5 extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfACFR_ProviderContactDetailsV5';
 ...
 this.registerEvents();
                this.setAttribute(
                  "class",
                  "card-0koBm0000000BZlIAM"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00PBm000000yM8vMAE").then(() =>{
                    //Loading Custom CSS.
                  })
                });
        ...
        this.pubsubChannel0 = interpolateWithRegex(`ACFR_ProviderContactDetailsV5`,this._allMergeFields,this._regexPattern,"noparse");
