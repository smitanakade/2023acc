...
import { OMNIDEF } from './recordNoticeTransferEnglish_def.js';
import tmpl from './recordNoticeTransferEnglish.html';
import tmpl_nds from './recordNoticeTransferEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class recordNoticeTransferEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
