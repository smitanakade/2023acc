...
import { OMNIDEF } from './serviceCombineEnglish_def.js';
import tmpl from './serviceCombineEnglish.html';
import tmpl_nds from './serviceCombineEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceCombineEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
