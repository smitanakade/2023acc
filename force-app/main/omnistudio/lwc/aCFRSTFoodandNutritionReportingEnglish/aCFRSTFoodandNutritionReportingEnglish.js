...
import { OMNIDEF } from './aCFRSTFoodandNutritionReportingEnglish_def.js';
import tmpl from './aCFRSTFoodandNutritionReportingEnglish.html';
import tmpl_nds from './aCFRSTFoodandNutritionReportingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRSTFoodandNutritionReportingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
