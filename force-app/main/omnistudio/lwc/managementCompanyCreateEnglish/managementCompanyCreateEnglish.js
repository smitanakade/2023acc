...
import { OMNIDEF } from './managementCompanyCreateEnglish_def.js';
import tmpl from './managementCompanyCreateEnglish.html';
import tmpl_nds from './managementCompanyCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class managementCompanyCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
