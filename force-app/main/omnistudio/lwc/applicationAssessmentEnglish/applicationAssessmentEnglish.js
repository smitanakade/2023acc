...
import { OMNIDEF } from './applicationAssessmentEnglish_def.js';
import tmpl from './applicationAssessmentEnglish.html';
import tmpl_nds from './applicationAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
