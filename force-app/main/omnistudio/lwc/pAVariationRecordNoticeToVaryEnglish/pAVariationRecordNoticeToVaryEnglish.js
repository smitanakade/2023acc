...
import { OMNIDEF } from './pAVariationRecordNoticeToVaryEnglish_def.js';
import tmpl from './pAVariationRecordNoticeToVaryEnglish.html';
import tmpl_nds from './pAVariationRecordNoticeToVaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pAVariationRecordNoticeToVaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
