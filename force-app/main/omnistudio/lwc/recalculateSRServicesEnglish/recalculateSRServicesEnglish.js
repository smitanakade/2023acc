...
import { OMNIDEF } from './recalculateSRServicesEnglish_def.js';
import tmpl from './recalculateSRServicesEnglish.html';
import tmpl_nds from './recalculateSRServicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class recalculateSRServicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
