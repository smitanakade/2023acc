...
import { OMNIDEF } from './aCFRSTApprovedProviderQuarterlyFinancialStatementsEnglish_def.js';
import tmpl from './aCFRSTApprovedProviderQuarterlyFinancialStatementsEnglish.html';
import tmpl_nds from './aCFRSTApprovedProviderQuarterlyFinancialStatementsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRSTApprovedProviderQuarterlyFinancialStatementsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
