...
import { OMNIDEF } from './applicationAATReviewEnglish_def.js';
import tmpl from './applicationAATReviewEnglish.html';
import tmpl_nds from './applicationAATReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationAATReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
