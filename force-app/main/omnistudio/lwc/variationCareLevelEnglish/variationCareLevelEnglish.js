...
import { OMNIDEF } from './variationCareLevelEnglish_def.js';
import tmpl from './variationCareLevelEnglish.html';
import tmpl_nds from './variationCareLevelEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationCareLevelEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
