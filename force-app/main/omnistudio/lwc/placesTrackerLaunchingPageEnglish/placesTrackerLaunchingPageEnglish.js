...
import { OMNIDEF } from './placesTrackerLaunchingPageEnglish_def.js';
import tmpl from './placesTrackerLaunchingPageEnglish.html';
import tmpl_nds from './placesTrackerLaunchingPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesTrackerLaunchingPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
