...
import { OMNIDEF } from './variationAccreditationEnglish_def.js';
import tmpl from './variationAccreditationEnglish.html';
import tmpl_nds from './variationAccreditationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationAccreditationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
