...
import { OMNIDEF } from './placesCeaseEnglish_def.js';
import tmpl from './placesCeaseEnglish.html';
import tmpl_nds from './placesCeaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesCeaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
