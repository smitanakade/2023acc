...
import { OMNIDEF } from './variationConditionEnglish_def.js';
import tmpl from './variationConditionEnglish.html';
import tmpl_nds from './variationConditionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationConditionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
