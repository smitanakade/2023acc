...
import { OMNIDEF } from './variationTableEnglish_def.js';
import tmpl from './variationTableEnglish.html';
import tmpl_nds from './variationTableEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationTableEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
