import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import { load } from "omnistudio/newportLoader";
          ...
          export default class cfACFR_AboutApprovedProviderResiViability extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfACFR_AboutApprovedProviderResiViability';
