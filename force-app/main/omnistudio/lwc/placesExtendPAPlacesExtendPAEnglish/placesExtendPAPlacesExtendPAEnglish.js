...
import { OMNIDEF } from './placesExtendPAPlacesExtendPAEnglish_def.js';
import tmpl from './placesExtendPAPlacesExtendPAEnglish.html';
import tmpl_nds from './placesExtendPAPlacesExtendPAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesExtendPAPlacesExtendPAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
