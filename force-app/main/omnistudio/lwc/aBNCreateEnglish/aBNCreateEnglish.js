...
import { OMNIDEF } from './aBNCreateEnglish_def.js';
import tmpl from './aBNCreateEnglish.html';
import tmpl_nds from './aBNCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aBNCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
