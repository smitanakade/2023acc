...
import { OMNIDEF } from './regulatoryDecisionUnlockedEnglish_def.js';
import tmpl from './regulatoryDecisionUnlockedEnglish.html';
import tmpl_nds from './regulatoryDecisionUnlockedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class regulatoryDecisionUnlockedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
