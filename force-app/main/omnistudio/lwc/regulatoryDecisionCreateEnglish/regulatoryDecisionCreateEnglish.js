...
import { OMNIDEF } from './regulatoryDecisionCreateEnglish_def.js';
import tmpl from './regulatoryDecisionCreateEnglish.html';
import tmpl_nds from './regulatoryDecisionCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class regulatoryDecisionCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
