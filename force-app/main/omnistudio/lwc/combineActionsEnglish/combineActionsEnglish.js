...
import { OMNIDEF } from './combineActionsEnglish_def.js';
import tmpl from './combineActionsEnglish.html';
import tmpl_nds from './combineActionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class combineActionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
