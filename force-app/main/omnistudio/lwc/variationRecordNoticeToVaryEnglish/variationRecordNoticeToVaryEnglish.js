...
import { OMNIDEF } from './variationRecordNoticeToVaryEnglish_def.js';
import tmpl from './variationRecordNoticeToVaryEnglish.html';
import tmpl_nds from './variationRecordNoticeToVaryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationRecordNoticeToVaryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
