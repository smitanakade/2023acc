...
import { OMNIDEF } from './cEICEIEnglish_def.js';
import tmpl from './cEICEIEnglish.html';
import tmpl_nds from './cEICEIEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cEICEIEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
