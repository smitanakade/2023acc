...
import { OMNIDEF } from './aCFRFoodAndNutritionCostsEnglish_def.js';
import tmpl from './aCFRFoodAndNutritionCostsEnglish.html';
import tmpl_nds from './aCFRFoodAndNutritionCostsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRFoodAndNutritionCostsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
