import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfServiceCombine_Discontinuing extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
            ...
            this.customEventName0 = interpolateWithRegex(`selectcards_DiscontinuingService`,this._allMergeFields,this._regexPattern,"noparse");
