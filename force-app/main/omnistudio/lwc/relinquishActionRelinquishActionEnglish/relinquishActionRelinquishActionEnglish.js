...
import { OMNIDEF } from './relinquishActionRelinquishActionEnglish_def.js';
import tmpl from './relinquishActionRelinquishActionEnglish.html';
import tmpl_nds from './relinquishActionRelinquishActionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class relinquishActionRelinquishActionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
