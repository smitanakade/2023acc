...
import { OMNIDEF } from './createAllotmentEnglish_def.js';
import tmpl from './createAllotmentEnglish.html';
import tmpl_nds from './createAllotmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createAllotmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
