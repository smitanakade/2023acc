...
import { OMNIDEF } from './aCFRFormCreationEnglish_def.js';
import tmpl from './aCFRFormCreationEnglish.html';
import tmpl_nds from './aCFRFormCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRFormCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
