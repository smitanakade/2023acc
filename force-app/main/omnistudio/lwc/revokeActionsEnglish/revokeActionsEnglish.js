...
import { OMNIDEF } from './revokeActionsEnglish_def.js';
import tmpl from './revokeActionsEnglish.html';
import tmpl_nds from './revokeActionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class revokeActionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
