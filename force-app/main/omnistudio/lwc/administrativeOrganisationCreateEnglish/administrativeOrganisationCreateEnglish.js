...
import { OMNIDEF } from './administrativeOrganisationCreateEnglish_def.js';
import tmpl from './administrativeOrganisationCreateEnglish.html';
import tmpl_nds from './administrativeOrganisationCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class administrativeOrganisationCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
