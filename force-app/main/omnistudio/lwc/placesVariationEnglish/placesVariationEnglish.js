...
import { OMNIDEF } from './placesVariationEnglish_def.js';
import tmpl from './placesVariationEnglish.html';
import tmpl_nds from './placesVariationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesVariationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
