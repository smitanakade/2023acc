...
import { OMNIDEF } from './placesPAVariationEnglish_def.js';
import tmpl from './placesPAVariationEnglish.html';
import tmpl_nds from './placesPAVariationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesPAVariationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
