...
import { OMNIDEF } from './ceasedPlacesEmergencyEnglish_def.js';
import tmpl from './ceasedPlacesEmergencyEnglish.html';
import tmpl_nds from './ceasedPlacesEmergencyEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class ceasedPlacesEmergencyEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
