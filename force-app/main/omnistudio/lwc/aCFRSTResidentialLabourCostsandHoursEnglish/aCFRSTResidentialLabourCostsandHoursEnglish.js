...
import { OMNIDEF } from './aCFRSTResidentialLabourCostsandHoursEnglish_def.js';
import tmpl from './aCFRSTResidentialLabourCostsandHoursEnglish.html';
import tmpl_nds from './aCFRSTResidentialLabourCostsandHoursEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRSTResidentialLabourCostsandHoursEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
