...
import { OMNIDEF } from './serviceDeliveryOrganisationCreateEnglish_def.js';
import tmpl from './serviceDeliveryOrganisationCreateEnglish.html';
import tmpl_nds from './serviceDeliveryOrganisationCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class serviceDeliveryOrganisationCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
