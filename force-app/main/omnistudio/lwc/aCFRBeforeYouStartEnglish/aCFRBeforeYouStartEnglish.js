...
import { OMNIDEF } from './aCFRBeforeYouStartEnglish_def.js';
import tmpl from './aCFRBeforeYouStartEnglish.html';
import tmpl_nds from './aCFRBeforeYouStartEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRBeforeYouStartEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
