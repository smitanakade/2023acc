...
import { OMNIDEF } from './placesTransferEnglish_def.js';
import tmpl from './placesTransferEnglish.html';
import tmpl_nds from './placesTransferEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesTransferEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
