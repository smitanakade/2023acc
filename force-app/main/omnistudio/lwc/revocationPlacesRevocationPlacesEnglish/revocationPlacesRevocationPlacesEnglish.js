...
import { OMNIDEF } from './revocationPlacesRevocationPlacesEnglish_def.js';
import tmpl from './revocationPlacesRevocationPlacesEnglish.html';
import tmpl_nds from './revocationPlacesRevocationPlacesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class revocationPlacesRevocationPlacesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
