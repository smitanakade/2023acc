...
import { OMNIDEF } from './sRQIRemoveStarRatingsEnglish_def.js';
import tmpl from './sRQIRemoveStarRatingsEnglish.html';
import tmpl_nds from './sRQIRemoveStarRatingsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sRQIRemoveStarRatingsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
