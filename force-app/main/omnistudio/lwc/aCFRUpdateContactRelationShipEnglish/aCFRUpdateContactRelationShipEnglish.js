...
import { OMNIDEF } from './aCFRUpdateContactRelationShipEnglish_def.js';
import tmpl from './aCFRUpdateContactRelationShipEnglish.html';
import tmpl_nds from './aCFRUpdateContactRelationShipEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRUpdateContactRelationShipEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
