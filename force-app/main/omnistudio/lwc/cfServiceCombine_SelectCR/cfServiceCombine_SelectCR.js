import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfServiceCombine_SelectCR extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfServiceCombine_SelectCR';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`ServiceCombine_SelectCR`,this._allMergeFields,this._regexPattern,"noparse");
