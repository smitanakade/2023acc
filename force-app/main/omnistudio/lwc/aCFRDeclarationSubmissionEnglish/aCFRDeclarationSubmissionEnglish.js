...
import { OMNIDEF } from './aCFRDeclarationSubmissionEnglish_def.js';
import tmpl from './aCFRDeclarationSubmissionEnglish.html';
import tmpl_nds from './aCFRDeclarationSubmissionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRDeclarationSubmissionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
