...
import { OMNIDEF } from './variationReductionEnglish_def.js';
import tmpl from './variationReductionEnglish.html';
import tmpl_nds from './variationReductionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationReductionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
