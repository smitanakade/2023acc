...
import { OMNIDEF } from './recordConditionsPlacesEnglish_def.js';
import tmpl from './recordConditionsPlacesEnglish.html';
import tmpl_nds from './recordConditionsPlacesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class recordConditionsPlacesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
