import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfPlaceByTargetGroupChildren extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfPlaceByTargetGroupChildren';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`PlacesSummary`,this._allMergeFields,this._regexPattern,"noparse");
