...
import { OMNIDEF } from './applicationReconsiderationOutcomeEnglish_def.js';
import tmpl from './applicationReconsiderationOutcomeEnglish.html';
import tmpl_nds from './applicationReconsiderationOutcomeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class applicationReconsiderationOutcomeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
