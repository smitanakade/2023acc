...
import { OMNIDEF } from './contactCreateEnglish_def.js';
import tmpl from './contactCreateEnglish.html';
import tmpl_nds from './contactCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contactCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
