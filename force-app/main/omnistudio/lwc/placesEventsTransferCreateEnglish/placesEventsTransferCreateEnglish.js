...
import { OMNIDEF } from './placesEventsTransferCreateEnglish_def.js';
import tmpl from './placesEventsTransferCreateEnglish.html';
import tmpl_nds from './placesEventsTransferCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesEventsTransferCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
