...
import { OMNIDEF } from './cHSPProviderCreateEnglish_def.js';
import tmpl from './cHSPProviderCreateEnglish.html';
import tmpl_nds from './cHSPProviderCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cHSPProviderCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
