...
import { OMNIDEF } from './newVariationConditionEnglish_def.js';
import tmpl from './newVariationConditionEnglish.html';
import tmpl_nds from './newVariationConditionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class newVariationConditionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
