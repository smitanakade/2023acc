...
import { OMNIDEF } from './placesChangeCareSettingEnglish_def.js';
import tmpl from './placesChangeCareSettingEnglish.html';
import tmpl_nds from './placesChangeCareSettingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesChangeCareSettingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
