...
import { OMNIDEF } from './varyServiceLocationActionsCreateEnglish_def.js';
import tmpl from './varyServiceLocationActionsCreateEnglish.html';
import tmpl_nds from './varyServiceLocationActionsCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class varyServiceLocationActionsCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
