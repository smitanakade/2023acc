...
import { OMNIDEF } from './summaryPageSummaryPageEnglish_def.js';
import tmpl from './summaryPageSummaryPageEnglish.html';
import tmpl_nds from './summaryPageSummaryPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class summaryPageSummaryPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
