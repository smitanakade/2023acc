...
import { OMNIDEF } from './regulatoryDecisionUnpublishedEnglish_def.js';
import tmpl from './regulatoryDecisionUnpublishedEnglish.html';
import tmpl_nds from './regulatoryDecisionUnpublishedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class regulatoryDecisionUnpublishedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
