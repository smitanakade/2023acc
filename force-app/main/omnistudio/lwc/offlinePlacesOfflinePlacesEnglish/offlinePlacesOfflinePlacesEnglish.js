...
import { OMNIDEF } from './offlinePlacesOfflinePlacesEnglish_def.js';
import tmpl from './offlinePlacesOfflinePlacesEnglish.html';
import tmpl_nds from './offlinePlacesOfflinePlacesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class offlinePlacesOfflinePlacesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
