import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfServiceCombine_SelectApplication extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfServiceCombine_SelectApplication';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`ServiceCombine_SelectApplication`,this._allMergeFields,this._regexPattern,"noparse");
        pubsub.register(this.pubsubChannel0,this.pubsubEvent[0]);

            this.customEventName0 = interpolateWithRegex(`selectcards_SelectedService`,this._allMergeFields,this._regexPattern,"noparse");
