...
import { OMNIDEF } from './nATSIFACPlacesCeaseEnglish_def.js';
import tmpl from './nATSIFACPlacesCeaseEnglish.html';
import tmpl_nds from './nATSIFACPlacesCeaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nATSIFACPlacesCeaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
