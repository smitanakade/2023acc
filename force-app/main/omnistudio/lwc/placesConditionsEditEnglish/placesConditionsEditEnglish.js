...
import { OMNIDEF } from './placesConditionsEditEnglish_def.js';
import tmpl from './placesConditionsEditEnglish.html';
import tmpl_nds from './placesConditionsEditEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesConditionsEditEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
