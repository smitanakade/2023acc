...
import { OMNIDEF } from './nATSIFACProviderCreateEnglish_def.js';
import tmpl from './nATSIFACProviderCreateEnglish.html';
import tmpl_nds from './nATSIFACProviderCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nATSIFACProviderCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
