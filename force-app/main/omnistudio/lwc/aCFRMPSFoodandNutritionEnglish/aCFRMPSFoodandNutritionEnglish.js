...
import { OMNIDEF } from './aCFRMPSFoodandNutritionEnglish_def.js';
import tmpl from './aCFRMPSFoodandNutritionEnglish.html';
import tmpl_nds from './aCFRMPSFoodandNutritionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRMPSFoodandNutritionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
