...
import { OMNIDEF } from './aCFRProviderContactEnglish_def.js';
import tmpl from './aCFRProviderContactEnglish.html';
import tmpl_nds from './aCFRProviderContactEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRProviderContactEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
