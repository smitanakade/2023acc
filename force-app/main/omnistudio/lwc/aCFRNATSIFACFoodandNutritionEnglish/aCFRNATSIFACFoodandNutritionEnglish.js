...
import { OMNIDEF } from './aCFRNATSIFACFoodandNutritionEnglish_def.js';
import tmpl from './aCFRNATSIFACFoodandNutritionEnglish.html';
import tmpl_nds from './aCFRNATSIFACFoodandNutritionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRNATSIFACFoodandNutritionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
