...
import { OMNIDEF } from './regulatoryDecisionPublishedEnglish_def.js';
import tmpl from './regulatoryDecisionPublishedEnglish.html';
import tmpl_nds from './regulatoryDecisionPublishedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class regulatoryDecisionPublishedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
