...
import { OMNIDEF } from './combineAdminActionsEnglish_def.js';
import tmpl from './combineAdminActionsEnglish.html';
import tmpl_nds from './combineAdminActionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class combineAdminActionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
