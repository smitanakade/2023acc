...
import { OMNIDEF } from './careLevelConvertEnglish_def.js';
import tmpl from './careLevelConvertEnglish.html';
import tmpl_nds from './careLevelConvertEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class careLevelConvertEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
