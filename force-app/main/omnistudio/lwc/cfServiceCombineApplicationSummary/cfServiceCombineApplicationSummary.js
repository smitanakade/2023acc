import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfServiceCombineApplicationSummary extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`DisplayServiceCombineSummary`,this._allMergeFields,this._regexPattern,"noparse");
