import { FlexCardMixin } from "omnistudio/flexCardMixin";
    ...
    import { load } from "omnistudio/newportLoader";
          ...
          export default class cfACFR_ResidentialLabourCostHoursAboutSection extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfACFR_ResidentialLabourCostHoursAboutSection';
              ...
              connectedCallback() {
                ...
                this.setAttribute(
                  "class",
                  "card-0ko9p00000005XaAAI"
                );
                this.getCommunityPrefix().then((result) => {
                  loadStyle(this, result +"/servlet/servlet.FileDownload?file=00P9p0000010GkCEAU").then(() =>{
                    //Loading Custom CSS.
                  })
                });
