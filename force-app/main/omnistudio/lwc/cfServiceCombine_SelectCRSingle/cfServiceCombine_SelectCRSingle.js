import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfServiceCombine_SelectCRSingle extends FlexCardMixin(OmniscriptBaseMixin(LightningElement)){
              @api debug;
              @api recordId;
              @api objectApiName;
              @track _omniSupportKey = 'cfServiceCombine_SelectCRSingle';
 ...
 this.registerEvents();
        ...
        this.pubsubChannel0 = interpolateWithRegex(`ServiceCombine_SelectCRSingle`,this._allMergeFields,this._regexPattern,"noparse");
        pubsub.register(this.pubsubChannel0,this.pubsubEvent[0]);

            this.customEventName0 = interpolateWithRegex(`selectcards_SelectedCRIds`,this._allMergeFields,this._regexPattern,"noparse");
