...
import { OMNIDEF } from './placesConditionEnglish_def.js';
import tmpl from './placesConditionEnglish.html';
import tmpl_nds from './placesConditionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesConditionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
