...
import { OMNIDEF } from './recalculateSRProvidersEnglish_def.js';
import tmpl from './recalculateSRProvidersEnglish.html';
import tmpl_nds from './recalculateSRProvidersEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class recalculateSRProvidersEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
