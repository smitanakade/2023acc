...
import { OMNIDEF } from './variationSDAEnglish_def.js';
import tmpl from './variationSDAEnglish.html';
import tmpl_nds from './variationSDAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class variationSDAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
