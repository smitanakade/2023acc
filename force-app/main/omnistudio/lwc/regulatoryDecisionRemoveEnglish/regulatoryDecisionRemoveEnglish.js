...
import { OMNIDEF } from './regulatoryDecisionRemoveEnglish_def.js';
import tmpl from './regulatoryDecisionRemoveEnglish.html';
import tmpl_nds from './regulatoryDecisionRemoveEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class regulatoryDecisionRemoveEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
