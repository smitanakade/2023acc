...
import { OMNIDEF } from './placesExtendPAActionsCreateEnglish_def.js';
import tmpl from './placesExtendPAActionsCreateEnglish.html';
import tmpl_nds from './placesExtendPAActionsCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class placesExtendPAActionsCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
