...
import { OMNIDEF } from './nATSIFACPlacesReinstateEnglish_def.js';
import tmpl from './nATSIFACPlacesReinstateEnglish.html';
import tmpl_nds from './nATSIFACPlacesReinstateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class nATSIFACPlacesReinstateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
