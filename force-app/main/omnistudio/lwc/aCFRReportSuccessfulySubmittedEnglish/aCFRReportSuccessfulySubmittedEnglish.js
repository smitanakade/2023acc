...
import { OMNIDEF } from './aCFRReportSuccessfulySubmittedEnglish_def.js';
import tmpl from './aCFRReportSuccessfulySubmittedEnglish.html';
import tmpl_nds from './aCFRReportSuccessfulySubmittedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRReportSuccessfulySubmittedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
