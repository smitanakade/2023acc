...
import { OMNIDEF } from './aCFRACFREnglish_def.js';
import tmpl from './aCFRACFREnglish.html';
import tmpl_nds from './aCFRACFREnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRACFREnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
