...
import { OMNIDEF } from './exemptionRemoveEnglish_def.js';
import tmpl from './exemptionRemoveEnglish.html';
import tmpl_nds from './exemptionRemoveEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class exemptionRemoveEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
