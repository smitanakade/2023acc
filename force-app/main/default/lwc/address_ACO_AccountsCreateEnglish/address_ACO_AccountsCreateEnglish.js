...
import { OMNIDEF } from './address_ACO_AccountsCreateEnglish_def.js';
import tmpl from './address_ACO_AccountsCreateEnglish.html';
import tmpl_nds from './address_ACO_AccountsCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class address_ACO_AccountsCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
