...
import { OMNIDEF } from './aCFRGetBeforeStartPDFEnglish_def.js';
import tmpl from './aCFRGetBeforeStartPDFEnglish.html';
import tmpl_nds from './aCFRGetBeforeStartPDFEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRGetBeforeStartPDFEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
