...
import { OMNIDEF } from './aCFRDeclarationManagementEnglish_def.js';
import tmpl from './aCFRDeclarationManagementEnglish.html';
import tmpl_nds from './aCFRDeclarationManagementEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRDeclarationManagementEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
