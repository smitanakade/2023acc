...
import { OMNIDEF } from './address_AccountsUpdateEnglish_def.js';
import tmpl from './address_AccountsUpdateEnglish.html';
import tmpl_nds from './address_AccountsUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class address_AccountsUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
