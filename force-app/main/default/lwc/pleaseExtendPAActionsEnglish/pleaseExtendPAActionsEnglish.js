...
import { OMNIDEF } from './pleaseExtendPAActionsEnglish_def.js';
import tmpl from './pleaseExtendPAActionsEnglish.html';
import tmpl_nds from './pleaseExtendPAActionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pleaseExtendPAActionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
