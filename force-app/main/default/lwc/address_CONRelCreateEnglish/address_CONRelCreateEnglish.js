...
import { OMNIDEF } from './address_CONRelCreateEnglish_def.js';
import tmpl from './address_CONRelCreateEnglish.html';
import tmpl_nds from './address_CONRelCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class address_CONRelCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
