...
import { OMNIDEF } from './address_AccountsAccounts_CreateEnglish_def.js';
import tmpl from './address_AccountsAccounts_CreateEnglish.html';
import tmpl_nds from './address_AccountsAccounts_CreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class address_AccountsAccounts_CreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
