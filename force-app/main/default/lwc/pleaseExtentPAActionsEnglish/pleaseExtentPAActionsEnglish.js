...
import { OMNIDEF } from './pleaseExtentPAActionsEnglish_def.js';
import tmpl from './pleaseExtentPAActionsEnglish.html';
import tmpl_nds from './pleaseExtentPAActionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class pleaseExtentPAActionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
