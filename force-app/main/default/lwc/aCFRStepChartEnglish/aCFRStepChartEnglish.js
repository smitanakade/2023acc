...
import { OMNIDEF } from './aCFRStepChartEnglish_def.js';
import tmpl from './aCFRStepChartEnglish.html';
import tmpl_nds from './aCFRStepChartEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class aCFRStepChartEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
