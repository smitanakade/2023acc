...
import { OMNIDEF } from './address_ServicesServicesEnglish_def.js';
import tmpl from './address_ServicesServicesEnglish.html';
import tmpl_nds from './address_ServicesServicesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class address_ServicesServicesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
