...
import { OMNIDEF } from './summaryPage_ThirdOrgSummaryPageEnglish_def.js';
import tmpl from './summaryPage_ThirdOrgSummaryPageEnglish.html';
import tmpl_nds from './summaryPage_ThirdOrgSummaryPageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class summaryPage_ThirdOrgSummaryPageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
