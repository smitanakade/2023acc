...
import { OMNIDEF } from './address_CONCreateEnglish_def.js';
import tmpl from './address_CONCreateEnglish.html';
import tmpl_nds from './address_CONCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class address_CONCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
