...
import { OMNIDEF } from './extendPAExtendPAEnglish_def.js';
import tmpl from './extendPAExtendPAEnglish.html';
import tmpl_nds from './extendPAExtendPAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class extendPAExtendPAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
